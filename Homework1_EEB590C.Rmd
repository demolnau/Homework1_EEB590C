...
uncor_data_sim<-replicate(100,random_corr_gen(100), simplify = "list")
#uncor_data_sim[,1]
#uncor_data_sim[,1]$x1
...
cor_data_sim<-replicate(100,rmvnorm(100, mean=c(0,0), sigma=matrix(c(1,corr.val,corr.val,1), 2, 2)), simplify ="list")
#cor_data_sim
#cor_data_sim[,1]
