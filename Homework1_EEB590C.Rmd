...
#TODO SUM THE NUMBER OF OCCURENCES WHERE THE PVALUE is LESS THAN 0.05. THIS SHOULD BE A COUNT AND WILL BE AN INTEGER
...
There is a significant linear relationship between x and y for the positively correlated model (model2) with an average p value less than 0.05.
